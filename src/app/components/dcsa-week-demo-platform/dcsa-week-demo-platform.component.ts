...
@Component({
  ...
  styles: [
    ...
    '.p-button.show-ebl-button { color: #009093; background: transparent; border-color: transparent; }',
    '.p-button.show-ebl-button.p-component:hover { color: #009093; background: transparent; border-color: transparent; }',
    '.p-button.show-ebl-button.p-component:disabled { color: #009093; background: transparent; border-color: transparent; }',
